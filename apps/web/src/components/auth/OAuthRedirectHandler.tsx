  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-neutral mb-4">Redirecting to OAuth Provider</h1>
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-primary mx-auto"></div>
        <p className="text-neutral-light mt-4">Please wait while we redirect you to the authentication provider...</p>
      </div>
    </div>
  );
}