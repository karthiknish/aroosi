  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        />
        {excerpt.trim() === "" && (
          <p className="text-xs text-danger mt-1">Excerpt is required.</p>
        )}
      </div>
      ...
      <div className="space-y-3 pt-2">
        ...
        <div className="flex flex-col md:flex-row gap-4 items-start">
          <div className="flex-1 w-full">
            <div className="flex gap-2">
              ...
              <Button
                ...
                className="h-11 px-4 whitespace-nowrap border-neutral/20 hover:bg-neutral/5 hover:text-neutral-dark"
                disabled={disabled}
              >
                <ImageIcon className="w-4 h-4 mr-2 text-neutral-light" />
                Search Pexels
              </Button>
            </div>
            
            {(!imageUrl || imageUrl.trim() === "") && (
              <p className="text-xs text-danger mt-1">Image URL is required.</p>
            )}
          ...
          {/* Image Preview Card */}
          <div className={cn(
            "w-full md:w-64 aspect-video rounded-xl border-2 border-dashed border-neutral/20 flex items-center justify-center overflow-hidden bg-neutral/5 relative group transition-all",
            imageUrl ? "border-solid border-neutral/20 shadow-sm" : ""
          )}>
            {imageUrl ? (
              <>
                <img
