...
export default function MessagesList(props: MessagesListProps) {
  ...
  // Infinite scroll - load older messages when scrolling to top (WhatsApp style)
        ...
        {showSearch && (
          ...
          >
            <div className="flex items-center gap-3 bg-neutral/5 rounded-xl px-3 py-2 border border-neutral/20">
              ...
              {searchQuery && (
                <div
                  className="flex items-center gap-1.5 text-xs text-neutral-light"
                  id="search-results"
                >
        ...
        {earlyContent ? (
          ...
          <>
            ...
            {empty ? (
              <div className="flex items-center justify-center h-full">
                <div className="text-center space-y-4 px-6">
                  <div className="w-20 h-20 bg-gradient-to-br from-warning/5 to-primary/5 rounded-2xl flex items-center justify-center mx-auto shadow-sm border border-warning/20">
                    <Smile className="w-9 h-9 text-warning" />
                  </div>
                  <div className="space-y-1.5">
                    <h3 className="font-semibold text-neutral text-lg tracking-tight">
                          ...
                          <div className="relative group inline-block pt-1">
                            <div
                              className={cn(
                                ...
                                "ring-2 ring-primary/50 shadow-xl scale-[1.02]",
                            ...
                            >
                              ...
                              {(msg as any).deleted ? (
                                <p className="text-xs italic text-neutral-light">
                              ...
                              {isCurrentUser &&
                                (msg as any).clientStatus === "failed" && (
                                  <div className="mt-1.5 text-right">
                                    <button
                                      className="text-[11px] text-danger font-medium hover:text-danger hover:underline transition-colors"
                                      onClick={() => {
        ...
        {showScrollToBottom && (
          ...
          >
            <Button
              ...
              className="rounded-2xl shadow-2xl bg-gradient-to-r from-primary to-primary-dark text-white hover:from-primary-dark hover:to-primary-dark border border-white/20 h-11 px-5 py-2.5 flex items-center gap-2.5 transition-all duration-300 hover:scale-105 hover:shadow-primary/30 active:scale-95 backdrop-blur-sm focus:ring-2 focus:ring-primary/50 focus:ring-offset-2"
              aria-label={
                unreadCount > 0
