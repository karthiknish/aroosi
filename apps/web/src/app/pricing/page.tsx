      ...
      <div className="relative pt-32 pb-16 px-4">
        <div className="max-w-7xl mx-auto">
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-gradient-to-r from-pink-50 to-rose-50">
                      ...
                      <th className="py-6 px-6 text-center font-semibold text-green-600 border-b border-gray-200 min-w-[120px] bg-green-50">
                        Free
                      </th>
                      <th className="py-6 px-6 text-center font-semibold text-pink-600 border-b border-gray-200 min-w-[120px] bg-pink-50">
                        Premium
                      </th>
                      <th className="py-6 px-6 text-center font-semibold text-amber-600 border-b border-gray-200 min-w-[120px]">
                        Premium Plus
                      </th>
                    </tr>
                  </thead>
          ...
          <motion.section
            ...
            className="py-20 relative overflow-hidden bg-gradient-to-r from-pink-600 via-rose-600 to-red-600"
          >
            {/* Decorative elements */}
            <div className="absolute inset-0 overflow-hidden">
              <div className="absolute -top-24 -right-24 w-96 h-96 bg-white rounded-full opacity-10 blur-3xl" />
              <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-white rounded-full opacity-5 blur-3xl" />
            </div>

            <div className="container mx-auto px-4 text-center relative z-10">
              <div className="max-w-4xl mx-auto">
                <h2 className="text-3xl sm:text-4xl leading-normal lg:text-5xl font-bold text-white mb-6">
