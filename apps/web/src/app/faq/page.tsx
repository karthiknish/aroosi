...
export default function FaqPage() {
  return (
    <>
      <Head>
        <title>FAQ - Aroosi | Frequently Asked Questions About Afghan Matrimony</title>
        <meta name="description" content="Find answers to common questions about Aroosi Afghan matrimony platform. Learn about membership plans, safety features, profile verification, matching system, and more." />
        <meta name="keywords" content="aroosi faq, afghan matrimony questions, membership help, profile setup, matching system, safety guidelines, subscription plans" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://aroosi.app/faq" />
        <meta property="og:title" content="FAQ - Aroosi | Frequently Asked Questions About Afghan Matrimony" />
        <meta property="og:description" content="Find answers to common questions about Aroosi Afghan matrimony platform. Learn about membership plans, safety features, and matching system." />
        ...
        <meta property="twitter:title" content="FAQ - Aroosi | Frequently Asked Questions About Afghan Matrimony" />
        <meta property="twitter:description" content="Find answers to common questions about Aroosi Afghan matrimony platform. Learn about membership plans, safety features, and matching system." />
        <meta property="twitter:image" content="https://aroosi.app/og-faq.png" />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              ...
              answer you&apos;re looking for? Our support team is here to help.
            </p>
