      ...
      <section className="pt-24 sm:pt-28 md:pt-32 pb-16 text-center bg-gradient-to-br from-pink-50 via-orange-50 to-yellow-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <h1
            ...
            className="text-5xl sm:text-6xl  lg:text-7xl font-bold bg-gradient-to-r from-pink-600 via-rose-500 to-orange-500 bg-clip-text text-transparent mb-6 leading-tight"
          >
            Matrimonial Blog
          </h1>
