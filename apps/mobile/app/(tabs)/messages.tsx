...
export default function MessagesScreen() {
    ...
    const handleConversationPress = useCallback((conversation: Conversation) => {
        ...
        if (conversation.user?.photoURL) {
            params.append('recipientPhoto', conversation.user.photoURL);
        }
    ...
    const handleMatchPress = useCallback((match: any) => {
        ...
        if (match.matchedUser.photoURL) {
            params.append('recipientPhoto', match.matchedUser.photoURL);
        }
        router.push(`/chat?${params.toString()}`);
    }, []);
