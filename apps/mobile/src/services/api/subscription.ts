 ...
 * Get available plans
 */
export async function getPlans(): Promise<ApiResponse<SubscriptionPlan[]>> {
 ...
 */
export async function checkPremiumAccess(): Promise<ApiResponse<{
    isPremium: boolean;
 ...
 */
export async function createCheckoutSession(planId: string, isYearly: boolean): Promise<ApiResponse<{ sessionId: string; url?: string }>> {
 ...
 * Cancel subscription
 */
export async function cancelSubscription(): Promise<ApiResponse<{ success: boolean }>> {
 ...
 */
export async function restorePurchases(receipt: string, platform: 'ios' | 'android'): Promise<ApiResponse<{
    restored: boolean;
 ...
 */
export async function verifyReceipt(receipt: string): Promise<ApiResponse<{
    valid: boolean;
    subscription?: Subscription;
}>> {
    return api.post<{
