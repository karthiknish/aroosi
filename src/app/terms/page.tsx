      ...
      <div className="bg-base-light pt-24 sm:pt-28 md:pt-32 pb-12 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <article className="prose prose-lg max-w-none text-neutral-light">
            ...
            <h2>2. Cookies</h2>
            <p>
              We employ the use of cookies. By accessing Aroosi, you agreed to
              use cookies in agreement with the Aroosi&apos;s Privacy Policy.
            </p>
            ...
            <p>
              ...
              from Aroosi for your own personal use subjected to restrictions
            ...
            <p>
              ...
              Comments do not reflect the views and opinions of Aroosi, its
