    ...
    <>
      ...
      <section className="relative flex flex-col md:flex-row items-center justify-between max-w-6xl mx-auto px-4 pt-24 pb-16 md:pt-32 md:pb-24">
        ...
        >
          ...
          >
            Find Your Ideal <span className="text-pink-600">Life Partner</span>{" "}
            in the UK
          </h1>
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="shadow-md">
              ...
              <CardContent className="text-center text-gray-600">
                Your data is protected. Only you control what you share and with
                whom.
              </CardContent>
            </Card>
            <Card className="shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800">Ahmed & Sarah</h3>
            ...
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div className="p-6 bg-white rounded-lg shadow-md">
                ...
                <p className="text-gray-600">
                  We prioritize your safety with robust verification and privacy
                  controls.
                </p>
              </div>
              <div className="p-6 bg-white rounded-lg shadow-md">
            ...
            <Accordion type="single" collapsible className="w-full space-y-4">
              ...
              >
                ...
                <AccordionContent className="text-gray-700">
                  ...
                  Aroosi is completely free. We offer optional premium features
