      ...
      <div className="relative pt-32">
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Getting started with Aroosi is easy. Follow these simple steps to
              begin your journey.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-3 max-w-5xl mx-auto">
            ...
            >
              <Card className="relative overflow-hidden transition-all duration-300 hover:shadow-xl bg-white/80 backdrop-blur-sm border-0 shadow-lg">
                ...
                <CardContent className="text-center text-gray-600 pb-8">
                  <p>
                    Browse verified profiles, filter by what matters to you, and
                    send interests to potential matches securely.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
            ...
            >
              <Card className="relative overflow-hidden transition-all duration-300 hover:shadow-xl bg-white/80 backdrop-blur-sm border-0 shadow-lg">
                ...
                <CardHeader className="pt-8 pb-4 text-center relative">
                  ...
                  <CardTitle className="text-xl mb-2">Connect & Chat</CardTitle>
                </CardHeader>
                <CardContent className="text-center text-gray-600 pb-8">
                  <p>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Your security and privacy are our top priorities. We&apos;ve built
              comprehensive safeguards to protect your journey.
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto">
            <Card className="relative overflow-hidden transition-all duration-300 hover:shadow-xl bg-white/80 backdrop-blur-sm border-0 shadow-lg">
              ...
              <CardContent className="text-center text-gray-600 pb-8">
                <p>
                  All profiles are manually reviewed before approval. We ensure
                  authenticity and remove fake accounts.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="relative overflow-hidden transition-all duration-300 hover:shadow-xl bg-white/80 backdrop-blur-sm border-0 shadow-lg">
              ...
              <CardContent className="text-center text-gray-600 pb-8">
                <p>
                  Your data is encrypted and never shared without consent. GDPR
                  compliant with full transparency.
                </p>
              </CardContent>
            </Card>
          </div>
