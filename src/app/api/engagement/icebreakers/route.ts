...
export async function GET(req: NextRequest) {
  try {
    const qs = await convexQueryWithAuth(req, (api as any).icebreakers.getDailyQuestions, {} as any);
...
export async function POST(req: NextRequest) {
  ...
  try {
    const res = await convexMutationWithAuth(req, (api as any).icebreakers.answerIcebreaker, parsed.data as any);
