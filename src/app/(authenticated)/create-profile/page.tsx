...
export default function CreateProfilePage() {
    ...
    async (values: ProfileFormValues) => {
      ...
      const attemptSubmit = async () => {
        try {
          ...
          // Prefetch success page then navigate
          router.prefetch("/create-profile/success");
  ...
  return (
    <div className="w-full min-h-screen bg-base-light flex flex-col relative overflow-x-hidden">
