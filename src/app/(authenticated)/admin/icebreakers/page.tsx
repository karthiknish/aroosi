    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600">
          Manage questions, toggle active, and tune weights.
        </p>
      </div>
      ...
      <Card>
        <CardContent className="p-4 flex gap-2 items-end">
          ...
          <div className="w-48">
            <label
              htmlFor="icebreaker-category"
              className="text-sm text-gray-700"
            >
              Category
            </label>
            <Input
              id="icebreaker-category"
              value={newCategory}
          ...
          <div className="w-28">
            <label
              htmlFor="icebreaker-weight"
              className="text-sm text-gray-700"
            >
              Weight
            </label>
            <Input
              id="icebreaker-weight"
              type="number"
                ...
                <TableRow key={q.id}>
                  <TableCell>
                    <Switch
                      checked={q.active}
                      onCheckedChange={(v) =>
                        mUpdate.mutate({ id: q.id, active: v })
                      }
                    />
                  </TableCell>
                  <TableCell>
                    <Input
                      ...
                      onBlur={(e) => {
                        ...
                        if (val !== q.text)
                          mUpdate.mutate({ id: q.id, text: val });
                      }}
                    />
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <Input
                      ...
                      onBlur={(e) => {
                        ...
                        if ((val ?? null) !== (q.weight ?? null))
                          mUpdate.mutate({ id: q.id, weight: val });
                      }}
                    />
                  </TableCell>
